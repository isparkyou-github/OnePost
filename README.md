...
```bash
git clone https://github.com/isparkyou-github/OnePost.git
cd OnePost
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/isparkyou-github/OnePost)

1. 点上方按钮（或打开 `https://render.com/deploy?repo=https://github.com/isparkyou-github/OnePost`）
